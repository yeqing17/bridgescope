...
mod tests {
    use super::*;
    use bridgescope_domain::ApplicationSnapshot;
    ...
    fn device_target() -> DeviceTarget {
        DeviceTarget::new(
            bridgescope_domain::DeviceSerial::new("emulator-5554").expect("valid serial"),
            1,
        )
    }
    ...
    fn icons_from_other_targets_are_ignored() {
        ...
        let other = DeviceTarget::new(
            bridgescope_domain::DeviceSerial::new("other").expect("valid serial"),
            1,
        );
        state.handle_event(&BackendEvent::ApplicationIconLoaded {
            target: other,
    ...
    fn tile_naming_derives_initials_and_short_names() {
        ...
        assert_eq!(tile_initial("com.bridgescope.demo"), "D");
