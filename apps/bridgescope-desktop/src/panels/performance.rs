...
use bridgescope_domain::{BackendCommand, BackendEvent, DeviceTarget, PerformanceSnapshot};
...
fn format_memory(metrics: &bridgescope_domain::PerformanceMetrics) -> String {
