*[中文](../clean-room.md) | English*

# Clean-room policy

Fadb reimplements Android debugging workflows independently.
...
- Fixtures captured by Fadb's own tests.
...
- Presenting Fadb as an official AYA or Android product.
