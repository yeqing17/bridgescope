...
fadb is an independently implemented, pure-Rust desktop toolkit for inspecting and managing Android devices through ADB. Current release: **0.8.6**; see [`CHANGELOG.md`](CHANGELOG.md) for the full history and [`docs/feature-matrix.md`](docs/en/feature-matrix.md) for scope and roadmap.
