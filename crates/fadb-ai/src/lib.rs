//! Provider-neutral AI assistant interface for Fadb.
//!
...
//! authorization that gates which Fadb state may be sent to a provider,
...
///
/// Fadb refuses to send device or session data to a provider that has
...
pub struct ProviderCapabilities {
    /// Provider accepts a system prompt describing Fadb itself.
